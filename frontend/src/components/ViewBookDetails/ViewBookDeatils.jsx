...
//     try {
//       const response = await axios.delete("https://novelnest-backend.onrender.com/api/delete-book", { headers });
//       alert(response.data.message);
//       navigate("/all-books");
//     } catch (error) {
...
//               <img
//                 src={Data.url}
//                 className="w-full h-60 md:h-80 lg:h-[70vh] object-cover rounded"
//                 alt="Book cover"
//               />
//               {isLoggedIn && role === "user" && (
//                 <div className="flex flex-row lg:flex-col items-center justify-between lg:justify-start mt-4 lg:mt-0 gap-4">
//                   <button
//                     className="bg-white rounded-full text-3xl text-red-500 flex items-center justify-center p-3 hover:bg-gray-200 transition"
...
//                   </button>
//                   <button
//                     className="bg-white rounded-full text-3xl text-blue-500 flex items-center justify-center p-3 hover:bg-gray-200 transition"
//                     onClick={handleCart}
//                   >
//                     <FaShoppingCart />
...
//             <p className="text-zinc-400 mt-4">{Data.language}</p>
                            ...
                            {isLoggedIn === true && role === "admin" && (
                                <div className="flex flex-row lg:flex-col items-center justify-between lg:justify-start mt-4 lg:mt-0">
                                    <Link to={`/updateBook/${id}`} className="bg-white rounded lg:rounded-full text-4xl text-red-500 flex items-center justify-center lg:text-3xl p-3">
                                        <FaEdit />
                                        <span className="ml-2  text-sm block lg:hidden">Edit</span>
                                    </Link>
                                    ...
                                    onClick={deleteBook}>
                                        <MdOutlineDelete />
                                        <span className="ml-2 text-sm block lg:hidden">Delete book</span>
                                    </button>
                                </div>
                            )}
                        </div>
